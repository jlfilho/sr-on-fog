...
This project is based on the implementation of the Pensive simulator project. We add two modules, the RTMP cloud server and super-resolution video service on the fog.
